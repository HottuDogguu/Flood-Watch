...
import com.example.myapplication.data.models.auth.RefreshTokenRequest;
...
public interface AuthenticationEndpoint {
    ...
    Call<ApiSuccessfulResponse> googleAuthenticateUser(@Body String token);



    //To link account in google
    @Headers({"Content-Type: application/json"})
    @POST("auth/linked/account")
    Call<ApiSuccessfulResponse> linkAuthenticateUser(@Body LinkAccountToMultipleSiginMethodsRequest request);
    ...
    @POST("auth/login")
    Call<ApiSuccessfulResponse> manualAuthenticateUser(@Field("username") String username,
    ...
    Call<ApiSuccessfulResponse> CreateAuthenticateUser(@Body SignupPostRequest signupPostRequest);
